  ...
  return (
    <TodoContextProvider>
      <div className="relative w-full min-h-screen bg-zinc-800">
        ...
        <Foreground />
        {createTodo && (
          <div className="absolute top-1/3 left-1/3 w-1/3 h-1/3 backdrop-blur-lg rounded-3xl z-50">
            <CreateTodo setCreateTodo={setCreateTodo} />
          </div>
        )}
        {searchTodo && (
          <div className="absolute top-1/3 left-1/3 w-1/3 h-1/4 backdrop-blur-lg rounded-3xl z-50">
